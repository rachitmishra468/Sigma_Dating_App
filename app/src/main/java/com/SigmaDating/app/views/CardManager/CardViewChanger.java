package com.SigmaDating.app.views.CardManager;
...
public class CardViewChanger extends BaseFlingAdapterView {
    ...
    public CardViewChanger(Context context) {
        this(context, null);
    }

    public CardViewChanger(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.SwipeFlingStyle);
    }

    public CardViewChanger(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CardViewChanger, defStyle, 0);
        MAX_VISIBLE = a.getInt(R.styleable.CardViewChanger_max_visible, MAX_VISIBLE);
        MIN_ADAPTER_STACK = a.getInt(R.styleable.CardViewChanger_min_adapter_stack, MIN_ADAPTER_STACK);
        ROTATION_DEGREES = a.getFloat(R.styleable.CardViewChanger_rotation_degrees, ROTATION_DEGREES);
        DETECT_LEFT_SWIPE = a.getBoolean(R.styleable.CardViewChanger_left_swipe_detect, true);
        DETECT_RIGHT_SWIPE = a.getBoolean(R.styleable.CardViewChanger_right_swipe_detect, true);
        DETECT_BOTTOM_SWIPE = a.getBoolean(R.styleable.CardViewChanger_bottom_swipe_detect, true);
        DETECT_TOP_SWIPE = a.getBoolean(R.styleable.CardViewChanger_top_swipe_detect, true);
        a.recycle();
    }
                ...
                flingCardListener = new FlingCardListener(this, mActiveCard, mAdapter.getItem(START_STACK_FROM),
                    ...
                    public void onClick(Object dataObject) {
                        if (mOnItemClickListener != null)
                            mOnItemClickListener.onItemClicked(0, dataObject, mActiveCard);
    ...
    public interface OnItemClickListener {
        void onItemClicked(int itemPosition, Object dataObject, View view);
    }
