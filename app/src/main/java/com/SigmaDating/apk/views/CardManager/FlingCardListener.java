...
public class FlingCardListener implements View.OnTouchListener {
    ...
    private final CardViewChanger parentView;
    ...
    public FlingCardListener(CardViewChanger cardViewChanger, View mActiveCard, Object item, float rotation_degrees, FlingListener flingListener) {
        this(cardViewChanger, mActiveCard, item, 15f,  0.33f,flingListener);
    }


   /* public FlingCardListener(SwipeCardView parent, View frame, Object itemAtPosition, FlingListener flingListener) {
        this(parent, frame, itemAtPosition, 15f,  0.33f,flingListener);
    }
*/
    public FlingCardListener(CardViewChanger parent, View frame, Object itemAtPosition, float rotation_degrees, float opacityEnd, FlingListener flingListener) {
        super();
        ...
        this.paddingLeft = ((ViewGroup) parentView.getParent()).getPaddingLeft();
    }
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (rightView != null && leftView != null){
                    ...
                    float alpha = (((aPosX - paddingLeft) / (parentWidth * OPACITY_END)));
